...
class SEOFields(models.Model):
    ...
    canonical_url = models.CharField(blank=True, null=True, help_text="Canonical URL to avoid duplicate content.")
    ...
    og_url = models.CharField(blank=True, null=True, help_text="URL to share on social platforms.")
